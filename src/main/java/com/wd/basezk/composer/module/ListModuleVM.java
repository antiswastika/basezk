...
public class ListModuleVM {
    ...
    private List<Cmodule> allModules;
 ...
 **************************************************************************************/
    ...
    public void doNew() throws InterruptedException {
        ListModelList<Cmodule> lml = (ListModelList) listboxNya.getModel();
        lml.clearSelection();
        this.executeDetail( new Cmodule() );
    }

    @SuppressWarnings({ "unchecked", "rawtypes" })
    @Command
    public void doEdit(@BindingParam("record") Cmodule objNya) throws InterruptedException {
        ListModelList<Cmodule> lml = (ListModelList) listboxNya.getModel();
        lml.clearSelection();
    ...
    public void doDelete() {
        ...
        for (Cmodule objs : lml) {
            if (lml.isSelected(objs)) {
                objsToDel.put(objs.getCmoduleId(), objs);
            }
        }
 ...
 **************************************************************************************/
    private void executeDetail(Cmodule cmoduleNya) throws InterruptedException {
        HashMap<String, Object> map = new HashMap<String, Object>();
        map.put("objListCtrl", this);
        map.put("selected", cmoduleNya);

        try {
            Executions.createComponents("/frontend/core/module/vFormModule.zul", null, map);
        } catch (Exception e) {
            //LOGGING
        }
    }
    ...
    private void loadData() {
        ...
        allModules = getCmoduleService().getByRequest(requestMap, false, null);

        BindUtils.postNotifyChange(null, null, this, "allModules");
    }

    private void deletingData(final Map<String, Cmodule> objsToDel) {
        for (Map.Entry<String, Cmodule> mapNya : objsToDel.entrySet()) {
            try {
                Cmodule v = mapNya.getValue();
                getCmoduleService().deleteData(v.getCmoduleId());
            } catch (Exception e) {
                //
            }
        }
 ...
 **************************************************************************************/
    ...
    public void setAllModules(List<Cmodule> allModules) {
    ...
    public void getDeletingData(final Map<String, Cmodule> objsToDel) {
